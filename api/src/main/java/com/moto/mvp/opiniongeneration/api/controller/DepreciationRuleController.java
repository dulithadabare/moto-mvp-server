...
import com.moto.mvp.opiniongeneration.core.endpoint.DepreciationRuleEndpoint;
...
{
    Logger logger = LoggerFactory.getLogger( DepreciationRuleController.class );

    private DepreciationRuleEndpoint endpoint;

    @Autowired
    public DepreciationRuleController( MotoPlatform motoPlatform )
    {
        endpoint = motoPlatform.getEndpoint( EndpointKey.DEPRECIATION_RULE_ENDPOINT.getEndPointKey() );
    }

    @CrossOrigin
    @GetMapping( "/depreciationRules" )
    ...
    @CrossOrigin
    @GetMapping( "/depreciationRules/{id}" )
    ...
    @CrossOrigin
    @PostMapping( "/depreciationRules" )
    public HttpEntity<BasicResponse> save( @RequestBody List<DepreciationRuleDAO> entityList )
    {
        return new HttpEntity<>( ExecutionUtils.execute(
    ...
    @CrossOrigin
    @DeleteMapping( "/depreciationRules" )
    public HttpEntity<BasicResponse> delete( @RequestBody List<DepreciationRuleDAO> entityList )
    {
        return new HttpEntity<>( ExecutionUtils.execute(
